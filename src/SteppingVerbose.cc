...
void SteppingVerbose::StepInfo()
{
	CopyState();
  /*
	//Jixie: do not print secondaries
	bool bNotPrint2ndaries = true;
	if(bNotPrint2ndaries)  {
	...
	if( verboseLevel >= 1 ){
		...
		if( verboseLevel >= 3 ){
			...
			G4cout << std::setw( 5) << "Step#" << " "
				...
				<< std::setw(11) << "Y(mm)"      << " "
				<< std::setw(11) << "Z(mm)"      << " "
				<< std::setw(11) << "KineE(MeV)" << " "
				<< std::setw(11) << "dE(KeV)"    << " "
				<< std::setw(11) << "StepL(mm)"  << " "
				<< std::setw(11)  << "TrackL(mm)" << " "
		...
		G4cout << std::setw(5) << fTrack->GetCurrentStepNumber() << " "
			<< std::setw(11) << fTrack->GetPosition().x()/mm << " "
			<< std::setw(11) << fTrack->GetPosition().y()/mm << " "
			<< std::setw(11) << fTrack->GetPosition().z()/mm << " "
      << std::setw(11) << fTrack->GetKineticEnergy()/MeV << " "
			<< std::setw(11)<< fStep->GetTotalEnergyDeposit()/keV << " "
      << std::setw(11)<< fStep->GetStepLength()/mm << " "
			<< std::setw(11) << fTrack->GetTrackLength()/mm << " ";
